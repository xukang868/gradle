...
| Tested with `1.5`, soft constrain upgrades according to semantic versioning
|
| [1.0, 2.0[
| 1.5
|
...
| Tested with `1.5`, restrict upgrades according to semantic versioning
| [1.0, 2.0[
|
| 1.5
|
...
| Oon the edge, latest release, no downgrade
|
| `latest.release`
|
|

...
public class ResolveExecutionStateExecuter implements TaskExecuter {
    private static final Logger LOGGER = LoggerFactory.getLogger(ResolveExecutionStateExecuter.class);
    ...
    public ResolveExecutionStateExecuter(
    ...
    public TaskExecuterResult execute(TaskInternal task, TaskStateInternal state, TaskExecutionContext context) {
        AfterPreviousExecutionState afterPreviousExecution = executionHistoryStore.load(task.getPath());
        context.setAfterPreviousExecution(afterPreviousExecution);

        BeforeExecutionState beforeExecution = createExecution(task, context.getTaskProperties(), afterPreviousExecution);
        context.setBeforeExecution(beforeExecution);
